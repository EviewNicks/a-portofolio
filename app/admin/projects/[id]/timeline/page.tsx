...
export default function TimelineManagementPage({ params }: PageParams) {
  ...
  useEffect(() => {
    params.then(({ id }) => {
      ...
      Promise.all([
        ...
        .then(([projResponse, ents, med]) => {
          // API returns { data: project }, extract the actual project
          setProject(projResponse?.data ?? null)
  ...
  return (
    <div className="space-y-8">
      ...
      <YouTubePreviewManager projectId={projectId} secret={secret} />
